...
export default function MapSection() {
    return (
        <section className="py-16 px-4 bg-[#f0f2f5]" id="mapa">
            <div className="container mx-auto max-w-5xl">
                {/* Localização: Disruptive Minimalist Map */}
                <div className="relative">
                    <div className="text-center mb-8">
                        <h2 className="text-4xl font-black text-[#004DB6] uppercase tracking-tight flex items-center justify-center gap-3">
                            <span className="bg-[#00AEEF] text-white p-2 rounded-xl rotate-3">
                    ...
                    <div className="relative w-full h-[600px] md:h-[500px] flex items-center justify-center">
                        ...
                        <div className="absolute inset-0 bg-white rounded-[2rem] md:rounded-[3rem] -rotate-1 scale-95 opacity-50 shadow-md"></div>

                        {/* Map Container with Creative Mask */}
                        <div className="relative w-full h-full rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl z-10 group">
                            <iframe
                            ...
                            >
                                <div className="flex items-start justify-between mb-4 md:mb-6">
                                    ...
                                    <div className="bg-[#00AEEF]/10 p-2 md:p-3 rounded-full">
                                        <MapPin className="w-5 h-5 md:w-6 md:h-6 text-[#00AEEF]" />
                                    </div>
                                </div>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    className="flex items-center justify-between w-full bg-[#004DB6] text-white p-4 rounded-xl font-bold text-sm hover:bg-[#003d91] transition-all shadow-lg hover:shadow-[#004DB6]/30 group"
                                >
